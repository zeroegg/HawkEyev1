...
class DetectionModel(paddle.nn.Layer):
    def __init__(self):
        ...
        self.conv2d0 = paddle.nn.Conv2D(out_channels=32, kernel_size=(6, 6), stride=2, padding=2, in_channels=3)
        self.silu0 = paddle.nn.Silu()
        self.conv2d1 = paddle.nn.Conv2D(out_channels=64, kernel_size=(3, 3), stride=2, padding=1, in_channels=32)
        ...
        self.conv2d4 = paddle.nn.Conv2D(out_channels=32, kernel_size=(3, 3), padding=1, in_channels=32)
        ...
        self.conv2d7 = paddle.nn.Conv2D(out_channels=128, kernel_size=(3, 3), stride=2, padding=1, in_channels=64)
        ...
        self.conv2d10 = paddle.nn.Conv2D(out_channels=64, kernel_size=(3, 3), padding=1, in_channels=64)
        ...
        self.conv2d12 = paddle.nn.Conv2D(out_channels=64, kernel_size=(3, 3), padding=1, in_channels=64)
        ...
        self.conv2d15 = paddle.nn.Conv2D(out_channels=256, kernel_size=(3, 3), stride=2, padding=1, in_channels=128)
        ...
        self.conv2d18 = paddle.nn.Conv2D(out_channels=128, kernel_size=(3, 3), padding=1, in_channels=128)
        ...
        self.conv2d20 = paddle.nn.Conv2D(out_channels=128, kernel_size=(3, 3), padding=1, in_channels=128)
        ...
        self.conv2d22 = paddle.nn.Conv2D(out_channels=128, kernel_size=(3, 3), padding=1, in_channels=128)
        ...
        self.conv2d25 = paddle.nn.Conv2D(out_channels=512, kernel_size=(3, 3), stride=2, padding=1, in_channels=256)
        ...
        self.conv2d28 = paddle.nn.Conv2D(out_channels=256, kernel_size=(3, 3), padding=1, in_channels=256)
        ...
        self.conv2d36 = paddle.nn.Conv2D(out_channels=128, kernel_size=(3, 3), padding=1, in_channels=128)
        ...
        self.conv2d42 = paddle.nn.Conv2D(out_channels=64, kernel_size=(3, 3), padding=1, in_channels=64)
        ...
        self.conv2d45 = paddle.nn.Conv2D(out_channels=128, kernel_size=(3, 3), stride=2, padding=1, in_channels=128)
        ...
        self.conv2d48 = paddle.nn.Conv2D(out_channels=128, kernel_size=(3, 3), padding=1, in_channels=128)
        ...
        self.conv2d51 = paddle.nn.Conv2D(out_channels=256, kernel_size=(3, 3), stride=2, padding=1, in_channels=256)
        ...
        self.conv2d54 = paddle.nn.Conv2D(out_channels=256, kernel_size=(3, 3), padding=1, in_channels=256)
        ...
        self.conv2d57 = paddle.nn.Conv2D(out_channels=255, kernel_size=(1, 1), in_channels=128)
        self.sigmoid0 = paddle.nn.Sigmoid()
        self.conv2d58 = paddle.nn.Conv2D(out_channels=255, kernel_size=(1, 1), in_channels=256)
        self.sigmoid1 = paddle.nn.Sigmoid()
        self.conv2d59 = paddle.nn.Conv2D(out_channels=255, kernel_size=(1, 1), in_channels=512)
    ...
    def forward(self, x0):
        ...
        x758 = paddle.reshape(x=x756, shape=[1, 3, 85, 80, 80])
        x760 = paddle.transpose(x=x758, perm=[0, 1, 3, 4, 2])
        x761 = x760
        x762 = self.sigmoid0(x761)
        x764 = paddle.split(x=x762, num_or_sections=[2, 2, 81], axis=4)
        x765, x766, x767 = x764
        x768 = x765 * x736
        x769 = x768 + x737
        x770 = 8.0
        ...
        x778 = paddle.reshape(x=x776, shape=[1, 19200, 85])
        x785 = self.conv2d58(x658)
        x787 = paddle.reshape(x=x785, shape=[1, 3, 85, 40, 40])
        x789 = paddle.transpose(x=x787, perm=[0, 1, 3, 4, 2])
        x790 = x789
        x791 = self.sigmoid1(x790)
        x793 = paddle.split(x=x791, num_or_sections=[2, 2, 81], axis=4)
        x794, x795, x796 = x793
        x797 = x794 * x736
        x798 = x797 + x734
        x799 = 16.0
        ...
        x807 = paddle.reshape(x=x805, shape=[1, 4800, 85])
        x814 = self.conv2d59(x730)
        x816 = paddle.reshape(x=x814, shape=[1, 3, 85, 20, 20])
        x818 = paddle.transpose(x=x816, perm=[0, 1, 3, 4, 2])
        x819 = x818
        x820 = self.sigmoid2(x819)
        x822 = paddle.split(x=x820, num_or_sections=[2, 2, 81], axis=4)
        x823, x824, x825 = x822
        x826 = x823 * x736
        x827 = x826 + x732
        x828 = 32.0
        ...
        x836 = paddle.reshape(x=x834, shape=[1, 1200, 85])
        x837 = [x778, x807, x836]
...
def main(x0):
    ...
    params = paddle.load(r'C:\Windows\System32\HawkEye\yolov5s_paddle_model\model.pdparams')
